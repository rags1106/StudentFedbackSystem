    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:#90125E  ;">
          ...
          <center><h2><b style="font-size: 20px;">STUDENT DETAILS</b></h2> </center>
        </div>
        <div class="modal-body" style="background-color:black  ;">
		   ...
		   <!--  <td style="display:none;">Student ID:</td><td> -->
			...
			<div class="row">
		<center> <button type="button" class="btn btn-primary"  data-dismiss="modal"  style="margin-bottom:20px;width:120px;" onclick="updateDetails1()">Update Details</button></center> </div><br>
        </div>
